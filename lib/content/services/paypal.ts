      ...
      steps: [
        {
          ...
          body: "In SMS Activate choose PayPal and pick the country your PayPal account is registered in. PayPal accounts are country-specific, and a number from a different country than the account is a mismatch its risk checks notice.",
        },
        {
        ...
        },
        {
          ...
          body: "The SMS says “Your PayPal security code is: 305174. It expires in 10 minutes.” It reaches the SMS Activate app in seconds — enter it before the ten minutes run out.",
        },
        {
    ...
    faqs: [
      {
        ...
        a: "Yes — it’s a real mobile number on a real network, and PayPal’s sign-up code arrives in the SMS Activate app within seconds. The code expires in ten minutes, so have the sign-up screen open when you request it.",
      },
      {
      ...
      steps: [
        {
          ...
          body: "В SMS Activate выберите PayPal и страну, в которой зарегистрирован ваш аккаунт PayPal. Аккаунты PayPal привязаны к стране, и номер из другой страны — несоответствие, которое его антифрод-проверки замечают.",
        },
        {
        ...
        },
        {
          ...
          body: "SMS гласит: «Your PayPal security code is: 305174. It expires in 10 minutes.» Она доходит до приложения SMS Activate за секунды — введите код, пока не истекли десять минут.",
        },
        {
    ...
    faqs: [
      {
        ...
        a: "Да — это настоящий мобильный номер в реальной сети, и регистрационный код PayPal приходит в приложение SMS Activate за секунды. Код действует десять минут, поэтому запрашивайте его с открытым экраном регистрации.",
      },
      {

...
export const telegramWithoutPhoneNumber: BlogPost = {
  ...
  en: {
    ...
    description:
      "Telegram always asks for a number — but it doesn’t have to be yours. Your real options: virtual numbers, landlines, Fragment, plus the privacy settings that matter.",
    excerpt:
  ...
  ru: {
    ...
    description:
      "Telegram всегда просит номер — но не обязательно ваш. Реальные варианты: виртуальный номер, городской телефон, Fragment, плюс настройки приватности, которые важны.",
    excerpt:
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Отбросим мифы — «регистрации по почте» никогда не существовало, а «моды APK без SIM» — это лотерея с вредоносным ПО. Остаются три легальных пути, и рассчитаны они на очень разных людей.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: "Для большинства читателей практичный выбор — первый. Виртуальный номер — это настоящий номер в реальной сети оператора: Telegram воспринимает его как любой другой мобильный, без особых условий и без ожидания аукциона. Так что перейдём к самой регистрации.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Весь процесс занимает пару минут. Понадобятся два приложения рядом — Telegram и SMS Activate: код придёт во второе, а ввести его нужно в первое.",
      },
      {
        type: "steps",
        items: [
          ...
          },
          {
            ...
            body: "Укажите имя (настоящее не обязательно) — и вы внутри. Прежде чем вступать в первую группу, потратьте две минуты на настройки приватности ниже: они важнее, чем то, какой номер вы использовали.",
          },
        ],
      },
      { type: "cta", serviceSlug: "telegram" },
      ...
      {
        type: "p",
        text: "Каким бы путём вы ни пошли, номер, использованный для верификации, теперь привязан к аккаунту — и по умолчанию Telegram показывает его вашим контактам и позволяет найти вас всем, у кого он сохранён. Две настройки и одна привычка закрывают эти дыры.",
      },
      {
        type: "list",
        items: [
          ...
          "Живите по юзернейму: задайте @username в настройках и делитесь именно им. Юзернеймы — это и есть задуманный в Telegram способ находить друг друга; номер телефона может остаться просто логином и ничем больше.",
        ],
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "Вот шаг, который пропускают, а потом жалеют. В Настройки → Конфиденциальность → Двухэтапная аутентификация задайте облачный пароль. С ним вход с нового устройства требует и код, и пароль — так что один лишь контроль над номером телефона никогда не даст забрать аккаунт.",
      },
      {
        type: "callout",
      ...
      {
        type: "p",
        text: "Вот и вся картина: аккаунт, который ведёт себя как любой другой в Telegram, находится только по юзернейму, защищён паролем — и указывает на номер, который никогда не был вашим.",
      },
      { type: "h2", id: "faq", text: "Частые вопросы" },
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Нет. Номер проверяется только при верификации. Не выходите из аккаунта и включите двухэтапную аутентификацию — и аккаунт будет работать сколько угодно: будущие коды входа Telegram доставляет в активную сессию, а не по SMS.",
          },
          {
